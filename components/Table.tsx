  ...
  return (
    <table className="table-auto w-full p-10 font-medium">
      <thead className="bg-neutral-900">
        <tr className="divide-x-2 divide-neutral-700 border-b-2 border-neutral-700 text-neutral-200">
      ...
      <tbody className="divide-y-2 divide-neutral-700 text-neutral-400">
        {[1, 2, 3, 4, 5, 6, 7, 7].map((i, index) => (
          <tr
            key={index}
            className={`divide-x-2 divide-neutral-700 cursor-pointer group hover:bg-neutral-900 ${
              index % 2 === 0 ? "bg-neutral-800/70" : "bg-neutral-800/90"
            }`}
          >
            <td className="px-4 py-4 text-left text-sm">{i}</td>
